...
module.exports.security = {
  ...
  //   allowRequestHeaders: 'content-type,x-token,token,conntype'
  // },

  cors: {
    allRoutes: true,
    allowOrigins:  '*', //['http://localhost:8080','http://localhost:8081','http://localhost:8082','http://localhost','http://localhost:9081'], //
