    ...
    ***************************************************************************/
    default: {
      ...
      ****************************************************************************/
      // ssl: true,
      // adapter: 'sails-mssql',
      // url: 'mssql://ed:edpc@localhost:1433/sails'

      adapter: 'sails-mysql',
      url: 'mysql://root:root@localhost:3306/farm'
    },
  ...
  ***************************************************************************/
  security: {
    ...
    ***************************************************************************/
    ...
    //   allowRequestHeaders: "content-type, authorization,x-token,token,conntype,x-csrf-token",
    //   allowAnyOriginWithCredentialsUnsafe: false
    // },
    cors: {
      allRoutes: true,
      allowOrigins: ['http://localhost:8080', 'http://localhost:8081','http://localhost:8082','http://localhost:8083', 'http://localhost', 'http://localhost:9081'], //'*', //
