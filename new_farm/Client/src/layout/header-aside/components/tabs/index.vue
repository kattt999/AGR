  ...
  data () {
    return {
      ...
      contextmenuListIndex: [
        { icon: 'times-circle', title:  this.$t('close.all'), value: 'all' }
      ],
      contextmenuList: [
        { icon: 'arrow-left', title: this.$t('close.left'), value: 'left' },
        { icon: 'arrow-right', title: this.$t('close.right'), value: 'right' },
        { icon: 'times', title: this.$t('close.other'), value: 'other' },
        { icon: 'times-circle', title: this.$t('close.all'), value: 'all' }
      ],
      tagName: '/index'
    }
