    ...
    return [
      {
        ...
        component: layoutHeaderAside,
        children: [
          { path: 'index', name: 'index', meta: { title: 'Home', auth: true }, component: utils.import('system/index') },
          { path: 'log', name: 'log', meta: { title: 'log', auth: true }, component: utils.import('system/log') },
          ...routes
        ]
      }
    ]
