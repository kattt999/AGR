<template>
  <div class="page-login">
    ...
    <div class="page-login--layer page-login--layer-time" flex="main:center ;">{{time}}</div>
          ...
          <div class="page-login--form">
            <el-card shadow="never">
              ...
              <!-- <d2-tencent-captcha @success="submit"> -->
                <d2-button size="default" type="primary" label="登录" @click="submit" class="button-login"/>
              <!-- </d2-tencent-captcha> -->
            </el-card>
